...
class ConfigurableExpansionTileState extends State<ConfigurableExpansionTile>
  ...
  void initState() {
    ...
    _iconTurns = _controller.drive(
      (widget.animatedWidgetTurnTween ?? ConfigurableExpansionTile._halfTween)
          .chain(
        widget.animatedWidgetTween ?? ConfigurableExpansionTile._easeInTween,
      ),
    );
  ...
  Widget _buildChildren(BuildContext context, Widget? child) {
    final borderSideColor = _borderColor.value ?? widget.borderColorStart;
    final headerColor =
    ...
    return Container(
      decoration: BoxDecoration(
        border: Border(
          ...
          bottom: BorderSide(
            color: widget.bottomBorderOn ? borderSideColor : Colors.transparent,
          ),
        ),
      ),
      child: Column(
